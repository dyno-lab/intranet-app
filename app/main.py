...
app.include_router(plantilla_duplicado_router, prefix="/ui/admin")  # /ui/admin/plantilla-duplicado/...
app.include_router(hoja_cotejo_admin_router, prefix="/ui/admin")  # /ui/admin/hoja-cotejo/...
