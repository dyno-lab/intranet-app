"""Municipalities used by Comunidad participant and program forms.

Source: https://www.pr.gov/gobierno-2/directorio-municipios
Kept locally so registration does not depend on an external service.
"""
