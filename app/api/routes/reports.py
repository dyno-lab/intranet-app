...
@router.get("/notas/pdf/download")
def notes_report_pdf_download(
    request: Request,
    proposal_id: int | None = None,
    month: str | None = None,
    year: str | None = None,
    ...
    context.update({
        "current_user": current_user,
        **build_notes_pdf_chart_images(context),
    })
    filename = _pdf_download_filename("notas", context)
    try:
        pdf_bytes = render_template_to_chromium_pdf_bytes(
            templates=templates,
            template_name="ui/reports/notas_pdf.html",
            context={**context, "request": request},
            request=request,
        )
        return Response(
        ...
        logger.exception("Chromium PDF renderer failed for Notas; falling back to wkhtmltopdf.")

    return _render_report_pdf_response(
        request,
        "ui/reports/notas_pdf.html",
        context,
        filename,
        error_detail="No se pudo generar el PDF. Intenta nuevamente o usa la version imprimible.",
    )
...
@router.get("/embarazo/pdf/download")
def pregnancy_summary_report_pdf_download(
    request: Request,
    proposal_id: int | None = None,
    month: str | None = None,
    year: str | None = None,
    ...
    try:
        pdf_bytes = render_template_to_chromium_pdf_bytes(
            templates=templates,
            template_name="ui/reports/embarazo_pdf.html",
            context={**context, "request": request},
            request=request,
        )
        return Response(
        ...
        logger.exception("Chromium PDF renderer failed for Embarazo; falling back to wkhtmltopdf.")

    return _render_report_pdf_response(
        request,
        "ui/reports/embarazo_pdf.html",
        context,
        filename,
        error_detail="No se pudo generar el PDF. Intenta nuevamente o usa la version imprimible.",
    )
...
@router.get("/desercion-escolar/pdf/download")
def school_dropout_summary_report_pdf_download(
    request: Request,
    proposal_id: int | None = None,
    month: str | None = None,
    year: str | None = None,
    ...
    try:
        pdf_bytes = render_template_to_chromium_pdf_bytes(
            templates=templates,
            template_name="ui/reports/desercion_escolar_pdf.html",
            context={**context, "request": request},
            request=request,
        )
        return Response(
        ...
        logger.exception("Chromium PDF renderer failed for Desercion Escolar; falling back to wkhtmltopdf.")

    return _render_report_pdf_response(
        request,
        "ui/reports/desercion_escolar_pdf.html",
        context,
        filename,
        error_detail="No se pudo generar el PDF. Intenta nuevamente o usa la version imprimible.",
    )
...
@router.get("/duplicado/pdf/download")
def duplicado_report_pdf_download(
    request: Request,
    proposal_id: int | None = None,
    month: str | None = None,
    year: str | None = None,
    ...
    return _render_report_pdf_response(
        request,
        "ui/reports/duplicado_pdf.html",
        context,
        _pdf_download_filename("duplicado", context),
...
@router.get("/por-programa/pdf/download")
def por_programa_report_pdf_download(
    request: Request,
    proposal_id: int | None = None,
    month: str | None = None,
    year: str | None = None,
    ...
    return _render_report_pdf_response(
        request,
        "ui/reports/por_programa_pdf.html",
        context,
        _pdf_download_filename("por_programa", context),
        error_detail="No se pudo generar el PDF. Intenta nuevamente o usa la versi\u00f3n imprimible.",
    )
