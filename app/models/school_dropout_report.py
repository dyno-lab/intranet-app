...
class SchoolDropoutReport(Base):
    __tablename__ = "school_dropout_reports"

    __table_args__ = (
        UniqueConstraint("proposal_id", "report_month", "report_year", "created_by_user_id", name="uq_school_dropout_reports_period_user"),
    )
